...
var cframeHeaderHtml =
	...
	+ '	<img class="visible-print-block" src="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/logo-print.svg" width="175" height="53" alt="City of Toronto">'
	+ '	<!-- <div id="global-alertbox" w3-include-html="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/components/globalalert/"></div> -->'
	+ '	<header id="header" role="banner">'
	+ '	<div class="container-fluid">'
	+ '	<div id="header-left">'
	+ '		<div id="logo">'
	+ '					<a href="https://www.toronto.ca/" data-wt_params="WT.z_click_from=header;;WT.z_cat=Home">'
	+ '			<img src="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/logo.svg" width="225" height="70" alt="City of Toronto">'
	+ '			</a>'
	+ '				</div>'
	...
	+ '						<button id="query-search" type="submit" class="btn btn-default"><img src="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/icon-search.svg" alt="Search"></button>'
	...
	+ '			</div>'
	+ '			<div w3-include-html="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/components/globalnav-header.html" id="main-nav-container"><a href="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/components/globalnav-header.html"></a></div>'
	+ '		</div>'
	+ '	</div>'
	+ '<!--startindex-->'
	+ '<!--stopindex-->'
	...
	+ '					<ul class="share-list">'
	+ '					    <li> <a target="shareit" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.toronto.ca%2Fservices-payments%2Fvenues-facilities-bookings%2Fgetting-married%2Fstep-1-applying-for-a-marriage-licence%2F" id="share-link-1"><img src="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/social_facebook.png" id="share-img-1" alt=""><span class="sr-only">Share to </span><span>Facebook</span></a> </li>'
	+ '					    <li> <a target="shareit" href="https://twitter.com/share?url=https%3A%2F%2Fwww.toronto.ca%2Fservices-payments%2Fvenues-facilities-bookings%2Fgetting-married%2Fstep-1-applying-for-a-marriage-licence%2F&amp;text=Step+1%3A+Apply+for+a+Marriage+Licence&amp;via=cityoftoronto" id="share-link-2"><img src="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/social_twitter.png" id="share-img-2" alt=""><span class="sr-only">Share to </span><span>Twitter</span></a> </li>'
	+ '					    <li> <a target="shareit" href="https://pinterest.com/pin/create/bookmarklet/?media=https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/share_toronto_twitter.jpg&amp;url=https%3A%2F%2Fwww.toronto.ca%2Fservices-payments%2Fvenues-facilities-bookings%2Fgetting-married%2Fstep-1-applying-for-a-marriage-licence%2F&amp;description=Step+1%3A+Apply+for+a+Marriage+Licence" id="share-link-3"><img src="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/social_pinterest.png" id="share-img-4" alt=""><span class="sr-only">Share to </span><span>Pinterest</span></a> </li>'
	+ '					    <li> <a target="shareit" href="http://www.linkedin.com/shareArticle?url=https%3A%2F%2Fwww.toronto.ca%2Fservices-payments%2Fvenues-facilities-bookings%2Fgetting-married%2Fstep-1-applying-for-a-marriage-licence%2F&amp;title=Step+1%3A+Apply+for+a+Marriage+Licence" id="share-link-4"><img src="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/social_linkedin.png" id="share-img-5" alt=""><span class="sr-only">Share to </span><span>LinkedIn</span></a> </li>'
	+ '					</ul>'
	+ '				    </div>'
	+ '				</div>'
...
var cframeFooterHtml =
	...
	+ ''
	+ '	<div w3-include-html="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/components/globalnav-footer.html?fb=false">'
	+ '		<a href="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/components/globalnav-footer.html?fb=false"></a>'
	+ '	</div>'
	+ ''
	+ '	    <!--stopindex-->'
	+ '	    <a href="#header" id="return-to-top">'
	+ '				<img src="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/back-to-top-arrow.png" alt=""/>'
	...
	+ '	    <div w3-include-html="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/components/globalnav-iwantto.html">'
	+ '		<a href="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/components/globalnav-iwantto.html"></a></div>'
	+ '	</div>'
	+ ''
...
faviconsHtml =
	'	<!-- Favicons -->'
	+ '	<link rel="apple-touch-icon" sizes="180x180" href="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/apple-touch-icon.png">'
	+ '	<link rel="icon" type="image/png" href="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/favicon-32x32.png" sizes="32x32">'
	+ '	<link rel="icon" type="image/png" href="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/favicon-16x16.png" sizes="16x16">'
	+ '	<link rel="mask-icon" href="https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/img/safari-pinned-tab.svg" color="#165788">'
	;
		...
		if (typeof w3IncludeHTML === "function") {
			...
			if ($("[w3-include-html]").length > 0) {
				w3IncludeHTML(function () {
					...
					scriptTag.src = "https://frontdesk-cdn.inter.prod-toronto.ca/themes/toronto_ca/js/scripts.js";
...
//remove header:contains("Time: ") as interim fix of extra header
fronteskMainEle.find(':header:contains("Time: ")').parent().remove();

//remove .confirmed-reservation header container {
fronteskMainEle.find('.confirmed-reservation').remove();
...
if (datelistElement.length > 0) {
	...
	divDateElements.each(function () {
		...
		if (hasMultipleLocations) {
			var timesListElements = $(this).find(".location");
		} else {
